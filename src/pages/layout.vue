    ...
    <Disclosure as="nav" class="bg-white border-b border-gray-200" v-slot="{ open }">
      ...
      <DisclosurePanel class="sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
          ...
          <div class="border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800 block pl-3 pr-4 py-2 border-l-4 text-base font-medium" @click="handleLogout">
              logout
          </div>
        </div>
